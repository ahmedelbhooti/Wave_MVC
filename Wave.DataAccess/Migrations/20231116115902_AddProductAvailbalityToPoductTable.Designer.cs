...
namespace Wave.DataAccess.Migrations
{
    ...
    [Migration("20231116115902_AddProductAvailbalityToPoductTable")]
    partial class AddProductAvailbalityToPoductTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wave.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wave.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wave.Models.Product", b =>
                {
                    ...
                    b.Property<string>("ProductAvailbality")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Wave.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wave.Models.OrderDetail", b =>
                {
                    b.HasOne("Wave.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Wave.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Wave.Models.OrderHeader", b =>
                {
                    b.HasOne("Wave.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
