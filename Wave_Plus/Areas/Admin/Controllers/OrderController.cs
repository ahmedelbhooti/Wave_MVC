...
namespace Wave_Plus.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult GetAll(string status)
        {
            ...
            {
                case "ondelivery":
                    objOrderHeaders = objOrderHeaders.Where(u => u.PaymentStatus == SD.PaymentStatusOnDelivery);
                    break;
                case "inprocess":
                ...
                case "cancelled":
                    ...
                    break;
                default:
                    objOrderHeaders = objOrderHeaders.Where(u => u.OrderStatus != SD.StatusCompleted && u.OrderStatus != SD.StatusCancelled);
                    break;
            }
